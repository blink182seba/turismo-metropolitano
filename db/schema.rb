...
ActiveRecord::Schema.define(version: 2018_10_26_210319) do
  ...
  create_table "trip_activities", force: :cascade do |t|
    ...
    t.index ["reservation_id"], name: "index_trip_activities_on_reservation_id"
  ...
  add_foreign_key "trip_activities", "reservations"
