...
ActiveRecord::Schema.define(version: 2018_10_23_050413) do
  ...
  create_table "trip_activities", force: :cascade do |t|
    ...
    t.index ["reservations_id"], name: "index_trip_activities_on_reservations_id"
  ...
  add_foreign_key "trip_activities", "reservations", column: "reservations_id"
